...
const Teams: React.FC = () => {
    ...
    const columns: ProColumns<any>[] = [
        ...
        },
        {
            ...
            hideInSearch:true,
            render: (dom, row) => {
                return <Link key={'linkgateway' + row.id} style={{ color: 'blue', textDecorationLine: 'underline' }} to={'/networks/gateway/routers?id=' + row.id + '&name=' + row.name + `&clusterId=${clusterId}`}>{dom}</Link>
            }
        },
        {
            dataIndex:'level',
